...
interface LocationState {
  ...
  /**
   * Set when the user was sent here after changing their password, so they're told to sign
   * in again with the new one rather than wondering why they were logged out.
   */
  message?: string;
}
...
export default function LoginPage() {
  ...
  return (
    <div className="login-50split-container">
      ...
      >
        <h1 className="sr-only">CSC Online Exam Portal — Staff Sign In</h1>
      ...
      <div className="login-right-form-panel">
        ...
        >
          ...
          <h2 className="login-card-title">Sign in to CSC Exam Portal</h2>
          <p className="login-card-subtitle">Welcome Back ! Enter your credentials below.</p>

          {/* ── Form ── */}
          <form onSubmit={handleSubmit(onSubmit)} className="login-form-element" noValidate>
            {/* Email Input */}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
            >
              {isSubmitting && <span className="login-spinner-icon" />}
            ...
            <div className="login-google-wrapper">
              {hasGoogleClientId ? (
                ...
                <button
                  type="button"
                  disabled={isSubmitting}
                  className="login-custom-google-btn"
                  onClick={() =>
                    setFormError(
            ...
            <div className="login-switch-portal-container">
              <span className="login-switch-label">Are you a Student?</span>
              <Link to="/studentlogin" className="login-switch-button">
      ...
      <style>{`
        ...
        .login-input-wrapper--error:focus-within {
        ...
        .login-eye-toggle:focus-visible {
        ...
        .login-spinner-icon {
          ...
          border-radius: 50%;
          animation: login-spin-anim 0.6s linear infinite;
        }
        ...
        .login-custom-google-btn:hover:not(:disabled) {
          border-color: #9ca3af;
          background: #f9fafb;
          box-shadow: 0 3px 10px rgba(0, 0, 0, 0.08);
        }
        .login-custom-google-btn:focus-visible {
          outline: 2px solid #153174;
          outline-offset: 2px;
        }
