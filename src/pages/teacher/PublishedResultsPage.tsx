...
import publishedResultsHeaderImg from '@/assets/dashboard_designs/Teacher/Published Results.png';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-xs grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 items-end">
        <div className="space-y-1 col-span-2">
          <Label htmlFor="search" className="text-xs font-black text-slate-500 uppercase tracking-wider">Student or Test</Label>
